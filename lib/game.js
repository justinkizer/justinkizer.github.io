  ...
  const tick = event => {
    ...
    for (var i = 0; i < customers.length; i++) {
      ...
      if (customers.length < 1) {
        ...
        levelText.font = "46px assets/ARCADECLASSIC.TTF";
        levelText.x = 385;
        levelText.y = 275;
        levelText.color = "#FFFFFF";
        levelText.text = `Level ${levelNum}`;
        var levelText2 = new createjs.Text();
        levelText2.font = "46px assets/ARCADECLASSIC.TTF";
        levelText2.x = 388;
        levelText2.y = 278;
